...
// Crear usuarios
//==========================
function CreaUser(nombre, apellidoP, apellidoM, email, password, rol, vehiculo) {
...
function GetUserId(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, usuario_1.default.findById({ _id: id }, 'nombre email rol status vehiculo')
                    .then(function (user) {
                    return user;
                })
                    .catch(function (mistake) {
...
function GetActiveUsers() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, usuario_1.default.find({ status: 'ACTIVO' })
                    .then(function (user) {
                    return user;
                })
                    .catch(function (mistake) {
...
// Modificar Usuarios
// ==========================
function ModifyUser(id, usuario) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
function DisableUser(id, stat) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, usuario_1.default.updateOne({ _id: id }, { $set: { status: stat } })
                    .then(function (user) {
                    return user;
                })
                    .catch(function (mistake) {
